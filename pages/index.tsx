...
import Teos from "../public/memoji 1.png";
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""}>
      <Head>
        <title>Teos Hoxha Portofolio</title>
      ...
      <main className="bg-white px-10 md:px-20 lg:px-40 dark:bg-gray-900">
        <section className="min-h-screen">
            ...
            <ul className="flex items-center">
              ...
              <li>
                <a
                  ...
                  download={""}
                  href="/assets/CV - Teos Hoxha (1).pdf"
                >
                  Resume
                </a>
              </li>
          ...
          <div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-white cursor-pointer">
            <a href="https://www.linkedin.com/in/teos-hoxha-24007822b/">
              {" "}
              <AiFillLinkedin />
            </a>
            <a href="https://www.instagram.com/teoshoxha/">
              {" "}
              <AiFillInstagram />
            </a>

            <a href="https://github.com/Teosii">
              <AiFillGithub />
            </a>
          </div>
          <div className="relative mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 overflow-hidden md:h-96 md:w-96">
            <Image src={Teos} alt={""} layout="fill" objectFit="cover" />
          </div>
        </section>
